...
class TaskType(enum.Enum):
    ...
    # Experiment only
    SIMILARITY_EXP = (16,)  # checking similarity between embedding of original sentence vs perturbed sentence
    PERPLEXITY_EXP = (17,)  # checking perplexity between original sentence vs perturbed sentence
