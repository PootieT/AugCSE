...
class MRPCEval(object):
    ...
    def do_prepare(self, params, prepare):
        ...
        samples = (
            self.mrpc_data["train"]["X_A"]
            + self.mrpc_data["train"]["X_B"]
            + self.mrpc_data["test"]["X_A"]
            + self.mrpc_data["test"]["X_B"]
        )
    ...
    def run(self, params, batcher):
        ...
        for key in self.mrpc_data:
            ...
            sorted_corpus = sorted(
                zip(self.mrpc_data[key]["X_A"], self.mrpc_data[key]["X_B"], self.mrpc_data[key]["y"]),
        ...
        return {"devacc": devacc, "acc": testacc, "f1": testf1, "ndev": len(trainA), "ntest": len(testA)}
