...
def batcher(params, batch):
    ...
    _, reps_h_t = gensen.get_representation(sentences, pool="last", return_numpy=True, tokenize=True)
    embeddings = reps_h_t
    return embeddings
...
reps_h, reps_h_t = gensen.get_representation(sentences, pool="last", return_numpy=True, tokenize=True)
