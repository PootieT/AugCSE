...
* [Motivation](nl_augmenter_docs/doc.md#motivation)
* [Review Criteria for Accepting Submissions](nl_augmenter_docs/doc.md#review-criteria-for-submissions)
...
After all pull-requests have been merged, 3 of the [most creative implementations](nl_augmenter_docs/doc.md#Three-most-creative-Implementations) would be selected and featured on this README page and on the NL-Augmenter [webpage](https://gem-benchmark.com/nl_augmenter).
